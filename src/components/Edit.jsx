                    ...
                    <Typography id="modal-modal-description" sx={{ mt: 2 }}>
                        ...
                        <div className='d-flex my-2 flex-wrap'>
                            {
                                ...
                                userInput?.skills?.map(item => (
                                    <span className='btn btn-primary d-flex align-items-center justify-content-center m-2'>{item} <button onClick={() => removeSkill(item)} className="text-light btn">X</button></span>
                                ))
                            }
                        </div>
                        ...
                        <div className="d-flex row p-3">
                            <TextField id="standard-basic-name" label="Write a short summary of yourself " variant="standard" multiline rows={4}
                                varients="standard" onChange={e => userInput({ ...userInput, summary: e.target.value })} value={userInput?.summary} />
                        </div>
